...
## downloading this images that we need for this test
...
## The label for each sample is a string, the name of the file (minus the file extension).
...
## For this purpose we will maintain two dictionaries, mapping characters to integers, and integers to characters, respectively.
...
https://keras.io/img/examples/vision/captcha_ocr/captcha_ocr_13_0.png
...
https://keras.io/img/examples/vision/captcha_ocr/captcha_ocr_19_1.png
'''
